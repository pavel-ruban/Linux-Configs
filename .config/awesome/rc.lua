...
awful.key({ modkey,           }, "c",     function () client.focus:lower() end),
 ...
 awful.key({ modkey, }, "g", function () awful.util.spawn("sudo -u noname google-chrome-stable http://google.com") end),
 awful.key({ modkey, }, "b", function () awful.util.spawn("sudo -u noname google-chrome-stable https://prj.adyax.com/projects/skimium/issues?query_id=1215") end),
 awful.key({ modkey, }, "h", function () awful.util.spawn(" sudo -u noname google-chrome-stable http://translate.google.ru/?hl=ru&tab=wTenve") end),
